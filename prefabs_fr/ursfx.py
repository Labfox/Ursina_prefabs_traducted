...
class SynthGUI(Entity):
    def __init__(self, **kwargs):
        ...
        self.wave_selector = ButtonGroup(("sinusoïdal", "triangle", "carré", "bruit"), parent=self.wave_panel, scale=.11, y=-.075)
    ...
    def paste_code(self, code=""):
        ...
        try:
            ...
            print('code ursfx invalide:', code)
