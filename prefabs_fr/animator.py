...
class Animator():
    ...
    def state(self, value):
        ...
        if not value in self.animations:
            print(self, "N'a pas d'animation:", value)
...
if __name__ == '__main__':
    ...
    Text("Appuyez <red>1<default>, <green>2<default> ou <violet>3<default> pour passser entre les différents moments de l'animation", origin=(0,-.5), y=-.4)
